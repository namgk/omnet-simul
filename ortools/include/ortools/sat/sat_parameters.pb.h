...
class SatParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:operations_research.sat.SatParameters) */ {
 ...
 private:
  ...
  inline void set_has_presolve_blocked_clause();
  inline void clear_has_presolve_blocked_clause();
  ...
  inline void set_has_find_multiple_cores();
  inline void clear_has_find_multiple_cores();
  inline void set_has_cover_optimization();
  inline void clear_has_cover_optimization();
  ...
  inline void set_has_optimize_with_max_hs();
  inline void clear_has_optimize_with_max_hs();
  inline void set_has_cp_model_presolve();
  inline void clear_has_cp_model_presolve();
  inline void set_has_enumerate_all_solutions();
  inline void clear_has_enumerate_all_solutions();
